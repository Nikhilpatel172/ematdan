        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header clear-filter" filter-color="green">
                    ...
                    <div class="container">
                            <form class="form-group" action="./admin_candidate.php" method="post">
                                    ...
                                    <div class="col-lg-4 col-md-12" >
                                        ...
                                        <div class="content">
                                            <div class="input-group form-group-no-border input-lg">
                                                ...
                                                <input type="text" name="user" class="form-control" placeholder="Admin Name" required/>
                                            </div>
                                            <div class="input-group form-group-no-border input-lg" >
                                                <span class="input-group-addon">
                                                    <i class="material-icons" style="color:white">lock</i>
                                                </span>
                                                <input type="password" name="pass" placeholder="Admin Password" class="form-control" required/>
                                            </div><br><br>
                                            <a href="admin_candidate.php"><input type="submit" class="btn btn-primary btn-round" name="signup_submit" value="Log in"></a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <br>
                        <!--<a href="admin_candidate.html"><button class="btn btn-primary btn-round" name="signup_submit" value="Sign me up">Login</button></a>-->
